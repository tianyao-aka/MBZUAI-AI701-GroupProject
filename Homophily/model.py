...
class PL_Model(pl.LightningModule):
    def __init__(self, in_dim,hidden_dim,struct_dim,num_classes,walk_len = 10,num_walk=10,lr=1e-3,weight_decay=1e-6,dset_name = 'Cora',use_gpu=False,layer_num=3):
        super().__init__()
        ...
        self.fpath = 'data/Cora_new/'
        self.data_list = glob('data/Cora_new/*.pt')
        # init data
        ...
        s = torch.load(self.fpath+'data_point_10.pt')
...
if __name__=='__main__':
    ...
    for _ in range(6):
        model = PL_Model(1433, 64, 6, 7, use_gpu=True, walk_len=10, num_walk=10, layer_num=layer_num)
