...
if __name__=='__main__':
    ...
    fpath ='data/squirrel_p0.5_q0.05/'
    print('fpath:',fpath)
    test_results = []
    for _ in tqdm(range(10)):
        ...
        model = PL_Model(2089, 64, 6, num_classes=5, use_gpu=True, walk_len=10, num_walk=10, layer_num=layer_num,dset_name='squirrel',fpath=fpath)
